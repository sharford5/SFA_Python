...
class ShotgunEnsembleClassifier():
    ...
    def eval(self, train, test, train_labels, test_labels):
        ...
        correctTesting, labels = self.predictEnsemble(self.model, test, test_labels)
    ...
    def predictEnsemble(self, models, testSamples, test_labels):
        ...
        pred_labels = []
        final_labels = [None for _ in range(len(test_labels))]
        for i, model in enumerate(models):
            correct, labels = self.predict(model, testSamples, test_labels)
